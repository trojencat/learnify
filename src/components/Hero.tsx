...
const Banner = () => {
  ...
  return (
    <section className="relative h-full w-full flex flex-col md:flex-row items-center justify-between p-10 bg-cover mx-auto my-0 rounded-lg overflow-hidden shadow-2xl">
      ...
      <h1
        ref={headingRef}
        className="text-4xl md:text-5xl font-extrabold text-gray-900 whitespace-pre-line"
      >
        Discover Your True Career Path with <span className="text-blue-500">Learnify</span>
      </h1>
